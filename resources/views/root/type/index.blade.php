        ...
        <div class="pagetitle d-sm-flex align-items-center justify-content-between p-3">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('root.type.index') }}">{{ __('app.type') }}</a></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card filter-card">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <div class="btn-group float-end">
                                    <a href="javascript:void(0)" class="btn btn-primary me-2" onclick="commonShowModal('{{ route('root.type.create') }}')">{{ __('app.create') }}</a>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('root.type.filter') }}" id="filter-form" class="filter-form d-none" onsubmit="commonFilter(); return false">
                            <div class="row">
