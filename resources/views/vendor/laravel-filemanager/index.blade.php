...
<div class="d-flex flex-row">
    <div id="tree" style="height: 95vh; overflow-x: hidden; overflow-y: auto"></div>
    ...
    <div id="main">
        ...
        <div class="row">
            <div class="col-12" style="overflow-x: hidden; overflow-y: auto; height: 95vh">
                <div id="content"></div>
...
<div class="modal fade" id="uploadFolderModal" tabindex="-1" role="dialog" aria-labelledby="myModalFolderLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalFolderLabel">{{ trans('laravel-filemanager::lfm.title-upload-folder') }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aia-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('lfm.upload_folder') }}" role='form' id='uploadFolderForm' name='uploadFolderForm'
                      method='post' enctype='multipart/form-data'>
                    <input type='hidden' name='working_dir' value="{{ request("working_dir") }}">
            ...
            <div class="modal-footer">
                <div class="row w-100">
                    <div class="col-6">
                        <button type="button" class="btn btn-primary w-100" onclick="uploadFolderSubmit(this)">
                            {{ trans('laravel-filemanager::lfm.title-upload-folder') }}
                        </button>
                    </div>
                    <div class="col-6">
...
<div id="carouselTemplate" class="d-none carousel slide bg-light" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <a class="carousel-label d-none"></a>
...
<script src="{{ asset('assets/bootstrap/4.1.3/js/bootstrap.bundle.min.js') }}">
...
<script>
    Dropzone.options.uploadForm = {
        ...
        acceptedFiles: "{{ $helper->availableMimeTypes() ? implode(',', $helper->availableMimeTypes()) : '' }}",
        maxFilesize: ({{ $helper->maxUploadSize() }} / 1000)
    }
</script>

<script>
    function uploadFolderSubmit(e) {
        let form = $(e).closest('.modal').find('form');
        ...
        let fileInput = $(form[0]).find('input[type="file"]')[0];
    ...
    function showPdfFile(file_name) {
        if (!file_name) return;
        $('#content div.item_name').filter(function () {
            return $(this).text().trim() === file_name;
        }).trigger('dblclick');
    }
</script>
</body>
