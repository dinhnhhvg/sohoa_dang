...
@section('content')
    <div class="content-title">
        <div class="pagetitle d-sm-flex align-items-center justify-content-between pb-3">
            <h1>{{ __('app.product') }}</h1>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin') }}">{{ __('app.admin') }}</a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('admin.product.index') }}">{{ __('app.product') }}</a></li>
                </ol>
            </nav>
        </div>
                ...
                <div class="card filter-card">
                    <div class="card-header">
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a href="javascript:void(0)" class="btn btn-primary me-2" onclick="commonShowModal('{{ route('admin.product.create') }}', '#common-modal-fullscreen')">{{ __('app.create') }}</a>
                                <div class="btn-group float-end">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript:void(0)" data-localStorage-name="adminProducts" onclick="showHideShowColumn(this)">{{ __('app.hide_show_column') }}</a>
                                    </div>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.product.filter') }}" id="filter-form" class="filter-form d-none" onsubmit="commonFilter(); return false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-3 col-sm-12">
                                    <div class="form-group mb-3">
                                        <select class="form-select select2" name="category_id" data-placeholder="{{ __('app.select_category') }}">
                                            <option></option>
