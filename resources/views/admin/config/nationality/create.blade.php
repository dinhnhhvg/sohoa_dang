...
<div class="modal-body">
    <form method="POST" action="{{ route('admin.nationality.store') }}" onsubmit="commonSubmit(this); return false" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" name="flag" class="form-control ps-3" value="{{ env('APP_DEFAULT_IMAGE') }}" placeholder="Chọn File" readonly="">
            ...
            <div class="col-md-12">
                <div class="form-group mb-3">
                    ...
                    <textarea class="form-control" name="description" placeholder="{{ __('app.enter_description') }}"></textarea>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group mb-3">
