...
<div class="modal-body">
    <form method="POST" action="{{ route('admin.language.store') }}" onsubmit="commonSubmit(this); return false" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="locale" placeholder="{{ __('app.enter_value') }}">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group mb-3">
