        ...
        <div class="pagetitle d-sm-flex align-items-center justify-content-between pb-3">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.language.index') }}">{{ __('app.language') }}</a></li>
                </ol>
            </nav>
        </div>
            ...
            <div class="col-12">
                <div class="col-12">
                    <div class="card filter-card">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    <div class="btn-group float-end">
                                        <a href="javascript:void(0)" class="btn btn-primary me-2" onclick="commonShowModal('{{ route('admin.language.create') }}')">{{ __('app.create') }}</a>
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="javascript:void(0)" data-localStorage-name="adminLanguages" onclick="showHideShowColumn(this)">{{ __('app.hide_show_column') }}</a>
                                        </div>
                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ route('admin.language.filter') }}" id="filter-form" class="filter-form d-none" onsubmit="commonFilter(); return false">
