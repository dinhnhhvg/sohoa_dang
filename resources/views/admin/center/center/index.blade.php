        ...
        <div class="pagetitle d-sm-flex align-items-center justify-content-between pb-3">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.center.index') }}">{{ __('app.center') }}</a></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card filter-card">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <div class="btn-group float-end">
                                    <a href="javascript:void(0)" class="btn btn-primary me-2" onclick="commonShowModal('{{ route('admin.center.create') }}', '#common-modal-lg')">{{ __('app.create') }}</a>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript:void(0)" data-localStorage-name="adminCenters" onclick="showHideShowColumn(this)">{{ __('app.hide_show_column') }}</a>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="commonExport('{{ route('admin.center.export') }}', this)">{{ __('app.export_excel') }}</a>
                                    </div>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.center.filter') }}" id="filter-form" class="filter-form d-none" onsubmit="commonFilter(); return false">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-3 col-sm-12">
                                    <div class="form-group mb-3">
                                        <select class="form-select select2" name="province_id[]" data-placeholder="{{ __('app.select_province') }}" multiple>
                                            <option></option>
