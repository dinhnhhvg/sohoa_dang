...
@section('content')
    <div class="content-title">
        <div class="pagetitle d-sm-flex align-items-center justify-content-between pb-3">
            <h1>{{ __('app.campaign') }}</h1>
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin') }}">{{ __('app.admin') }}</a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('admin.campaign.index') }}">{{ __('app.campaign') }}</a></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card filter-card">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <div class="btn-group float-end">
                                    <a href="javascript:void(0)" class="btn btn-primary me-2" onclick="commonShowModal('{{ route('admin.campaign.create') }}', '#common-modal-xl')">{{ __('app.create') }}</a>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript:void(0)" data-localStorage-name="adminCampaigns" onclick="showHideShowColumn(this)">{{ __('app.hide_show_column') }}</a>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="commonExport('{{ route('admin.campaign.export') }}', this)">{{ __('app.export_excel') }}</a>
                                    </div>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.campaign.filter') }}" id="filter-form" class="filter-form d-none" onsubmit="commonFilter(); return false">
