            ...
            <div class="tab-content">
                <div class="tab-pane fade p-3 active show" id="tab-list" role="tabpanel">
                    <ul class="timeline-with-icons m-2">
                        @foreach($campaignCustomer->itemNotes as $note)
                    ...
                    {!! renderSearchEmpty($campaignCustomer->itemNotes) !!}
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select select2" name="status_id" required data-placeholder="{{ __('app.select_status') }}">
                                        @foreach($statuses as $status)
                                            <option value="{{ $status->id }}" {{ $status->id == $campaignCustomer->status_id ? 'selected' : '' }}>
                                                {{ __('app.'.$status->name) }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control datetimepicker" name="schedule_at" value="{{ $campaignCustomer->schedule_at?->format('d-m-Y H:i') }}" data-format="d-m-Y H:i" placeholder="{{ __('app.schedule_at') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="note" placeholder="{{ __('app.enter_note') }}" required></textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group mb-3">
