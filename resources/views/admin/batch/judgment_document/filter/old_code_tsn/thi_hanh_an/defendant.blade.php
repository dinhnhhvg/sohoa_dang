...
<td>{{ renderCodeName($defendant->foreign_document_number) }}</td>
<td>{{ $defendant->identity_number }}</td>

<td class="text-nowrap">{{ $defendant->father_name }}</td>
<td class="text-nowrap">{{ $defendant->father_name }}</td>
<td class="text-nowrap">{{ $defendant->spouse_name }}</td>

<td>{{ $defendant->execution_status }}</td>
<td class="text-nowrap">{{ $defendant->execution_date?->format('d/m/Y') }}</td>
<td>
