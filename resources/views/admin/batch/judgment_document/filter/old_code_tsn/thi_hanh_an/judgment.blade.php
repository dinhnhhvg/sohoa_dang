<div class="table-responsive">
    <table class="table table-list table-scroll table-bordered table-striped table-condensed no-nowrap w-100">
        ...
        <tr>
            ...
            <th colspan="2">{{ __('app.execution_of_judgment') }}</th>
        </tr>
        <tr>
            ...
            <th rowspan="2" class="text-nowrap">{{ __('app.execution_status') }}</th>
            <th rowspan="2" class="text-nowrap">{{ __('app.execution_date') }}</th>
        </tr>
        <tr>
