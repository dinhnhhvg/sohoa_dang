...
<div class="modal-body">
    <form method="POST" action="{{ route('admin.old_ward.store') }}" onsubmit="commonSubmit(this); return false" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-3">
                    <label class="form-label">{{ __('app.province') }}<span class="text-danger">*</span></label>
                    <select class="form-select select2" name="old_province_id" onchange="getOldDistrictByOldProvince(this)" data-placeholder="{{ __('app.select_province') }}">
                        <option value=""></option>
            ...
            <div class="col-md-12">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" name="prefix" placeholder="{{ __('app.enter_prefix') }}">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group mb-3">
