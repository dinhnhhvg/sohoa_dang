...
<div class="modal-body">
    <form method="POST" action="{{ route('admin.user.store') }}" onsubmit="commonSubmit(this); return false" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control datepicker" name="birth_date" data-format="d-m-Y" required>
