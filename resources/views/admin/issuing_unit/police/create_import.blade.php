...
<div class="modal-body">
    <form method="POST" action="{{ route('admin.police.store_import') }}" onsubmit="commonSubmit(this); return false" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="form-group mb-3">
                    {{ __('app.sample_file') }}: <a href="{{ route('admin.police.download_import') }}">Download</a>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group mb-3">
