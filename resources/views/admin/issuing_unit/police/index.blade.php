        ...
        <div class="pagetitle d-sm-flex align-items-center justify-content-between pb-3">
            ...
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.police.index') }}">{{ __('app.police') }}</a></li>
                </ol>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card filter-card">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <div class="btn-group float-end">
                                    <a href="javascript:void(0)" class="btn btn-primary me-2" onclick="commonShowModal('{{ route('admin.police.create') }}', '#common-modal-lg')">{{ __('app.create') }}</a>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript:void(0)" data-localStorage-name="adminPolices" onclick="showHideShowColumn(this)">
                                            {{ __('app.hide_show_column') }}
                                        </a>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="commonShowModal('{{ route('admin.police.create_import') }}', '#common-modal-lg')">
                                            {{ __('app.import_excel') }}
                                        </a>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="commonExport('{{ route('admin.police.export') }}', this)">
                                            {{ __('app.export_excel') }}
                                        </a>
                    ...
                    <div class="card-body">
                        <form method="GET" action="{{ route('admin.police.filter') }}" id="filter-form" class="filter-form" onsubmit="commonFilter(); return false">
