...
return [
    ...
    */
    ...
    'ascii' => 'Trường :attribute chỉ có thể chứa ký tự và ký hiệu chữ cái số byte đơn.',
    ...
    'lte' => [
        'array' => 'Trường :attribute không được có hơn :value mục.',
    ...
    'password' => [
        ...
        'uncompromised' => ':attribute đã bị lộ trong một vụ rò rỉ dữ liệu. Hãy chọn :attribute khác.',
    ],
    ...
    'custom.file_exist' => 'Trường :attribute Không tồn tại.',
    'custom.file_valid' => 'Trường :attribute phải là một file :types hợp lệ',
    'custom.unique_composite' => 'Trường :attribute đã tồn tại trong danh sách :table.',
    'custom.unique_date' => 'Trường :attribute đã tồn tại trong danh sách :table.',
    'custom.unique_datetime' => 'Trường :attribute đã tồn tại trong danh sách :table.',
