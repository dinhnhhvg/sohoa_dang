...
return [
    ...
    'private_folder_name'      => LfmConfigHandler::class,
    ...
    'folder_categories'        => [
        'user'  => [
            'folder_name'  => env('APP_FILE_MANAGE_USER_FOLDER_NAME'),
            'startup_view' => 'list',
            'max_size'     => 512000, // size in KB
            'thumb' => true,
            'thumb_width' => 80,
            'thumb_height' => 80,
        ...
        'root'  => [
            'folder_name'  => env('APP_FILE_MANAGE_ROOT_FOLDER_NAME'),
            'startup_view' => 'list',
            'max_size'     => 512000, // size in KB
            'thumb' => true,
            'thumb_width' => 80,
