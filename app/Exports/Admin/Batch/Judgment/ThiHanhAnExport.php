...
class ThiHanhAnExport extends BaseExport implements WithEvents
{
    ...
    public function map(mixed $row): array
    {
        if (isset($row->defendant) && !empty((array)$row->defendant)) {
            $defendantData = [
                $row->defendant->execution_status,
                $row->defendant->execution_date?->format('d/m/Y'),
                ...
                renderManyName($row->defendant->judicialMeasureNames), // Sửa lỗi chữ s số nhiều chỗ này luôn
    ...
    private function headerTree(): array
    {
        return [
            ...
            ['label' => __('app.execution_status')],
            ['label' => __('app.execution_date')],
