...
class CustomDeleteController extends DeleteController
{
    public function getDelete()
    {
        ...
        foreach ($item_names as $name_to_delete) {
            ...
            if ($this->lfm->setName($name_to_delete)->isDirectory()) {
                ...
                // XÓA TOÀN BỘ FOLDER + FILE BÊN TRONG
                Storage::disk($this->helper->config('disk'))
                    ->deleteDirectory($this->lfm->setName($name_to_delete)->path('storage'));
